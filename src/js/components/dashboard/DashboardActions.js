            ...
            {followers && followers.length > 0 ? (
              followers.map((follower, i) => (
                <div className="profiles__profile" key={i} >
                  <img className="profiles__profile-img" src={follower.user_avatar} alt="user avatar image"/>
            ...
            {followings && followings.length > 0 ? (
              followings.map((following, i) => (
                <div className="profiles__profile dash-follow" key={i} >
                  <img className="profiles__profile-img" src={following.user_avatar} alt="user avatar image"/>
                  <div className="profiles__profile-info">
