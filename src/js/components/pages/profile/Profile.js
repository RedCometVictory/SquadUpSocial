      ...
      {loading ? (
        ...
        <div className="profile-page-wrapper profile">
          <div className="profile__header-image">
            {profileStats === null ? (
              <img className="profile__profile-bg-image" src="" alt="profile-image"/>
            ) : !profileStats.profileDetails ?(
              <img src="" alt="profile-image"/>
            ) : (
              <img className="profile__profile-bg-image" src={profileStats.profileDetails.background_image} alt="profile image"/>
            )}
          </div>
